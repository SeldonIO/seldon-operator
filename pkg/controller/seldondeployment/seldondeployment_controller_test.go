...
func coreDeploymentTests(instance *machinelearningv1alpha2.SeldonDeployment, t *testing.T) {
	g := gomega.NewGomegaWithT(t)
	var expectedRequest = reconcile.Request{NamespacedName: types.NamespacedName{Name: instance.Name, Namespace: "default"}}
...
func TestReconcileSimpleModel(t *testing.T) {
	...
	coreDeploymentTests(instance, t)
}

func TestReconcileModelLongName(t *testing.T) {
	instance := &machinelearningv1alpha2.SeldonDeployment{}

	bStr := helperLoadBytes(t, "model_long_name.json")
	json.Unmarshal(bStr, instance)
